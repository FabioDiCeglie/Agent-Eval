...
class MCPClient:
    """
    Thin client that forwards tool calls to the MCP Gateway via Streamable HTTP.

    Reads MCP_GATEWAY_URL and MCP_GATEWAY_TOKEN from the environment by default.
    """
    ...
    def __init__(
        ...
        *,
        ...
        self.token = token or os.environ.get("MCP_GATEWAY_TOKEN")
